    ...
    <div className="flex flex-col h-full">
      ...
      <div ref={scrollRef} className="flex-1 overflow-y-auto">
        <div className="p-4 space-y-5">
            ...
            >
              <div className="space-y-2">
                {[
                  ...
                  <label key={option.value} className="flex items-start gap-3 cursor-pointer group px-2 py-1.5 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                    <input
                      type="radio"
                      name="outputFormat"
                      value={option.value}
                      ...
                      className="mt-0.5 w-3 h-3 text-healthcare-500 focus:ring-0 focus:ring-offset-0 border-gray-300 dark:border-gray-600"
                    />
            ...
            >
              <div className="space-y-2">
                {[
                  ...
                  <label key={action.value} className="flex items-start gap-3 cursor-pointer group px-2 py-1.5 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                    <input
                      type="checkbox"
                      checked={settings.actionTypes.includes(action.value)}
                      onChange={() => toggleActionType(action.value)}
                      className="mt-0.5 w-3 h-3 rounded border-gray-300 dark:border-gray-600 text-healthcare-500 focus:ring-0 focus:ring-offset-0"
                    />
                    <div className="flex-1">
            ...
            >
              <div className="space-y-2">
                {[
                  ...
                  <label key={style.value} className="flex items-start gap-3 cursor-pointer group px-2 py-1.5 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                    <input
                      type="radio"
                      name="responseStyle"
                      value={style.value}
            ...
            >
              <div className="space-y-2">
                {[
                  ...
                  <label key={level.value} className="flex items-start gap-3 cursor-pointer group px-2 py-1.5 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                    <input
                      type="radio"
                      name="detailLevel"
                      value={level.value}
            ...
            >
              <div className="space-y-2">
                <label className="flex items-start gap-3 cursor-pointer group px-2 py-1.5 rounded-md hover:bg-gray-50 dark:hover:bg-gray-800/50 transition-colors">
                  <input
                    type="checkbox"
